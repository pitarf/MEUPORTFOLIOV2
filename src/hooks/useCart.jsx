...
// Helper to replace the missing EcommerceApi
const formatCurrency = (valueInCents, currencyInfo) => {
    // Fallback if currencyInfo is missing
    const currency = currencyInfo?.code || 'BRL';
